# Generated by Django 4.2.5 on 2023-09-19 07:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='shop.country')),
            ],
            options={
                'ordering': ['name'],
            },
        ...
        migrations.AddIndex(
            model_name='country',
            index=models.Index(fields=['name'], name='shop_countr_name_ad5343_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
